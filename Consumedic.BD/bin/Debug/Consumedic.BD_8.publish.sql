...
GO
PRINT N'Creando [dbo].[MedicalCenters]...';
...
GO
PRINT N'Creando [dbo].[MedicalCenterSpecialists]...';
...
GO
ALTER TABLE [dbo].[MedicalCenterSpecialists]
    ADD CONSTRAINT [FK_MedicalCenterSpecialist_MedicalCenter] FOREIGN KEY ([MedicalCenterGuid]) REFERENCES [dbo].[MedicalCenters] ([MedicalCenterGuid]);
...
ALTER TABLE [dbo].[MedicalCenterSpeciality]
    ADD CONSTRAINT [FK_MedicalCenterSpeciality_MedicalCenter] FOREIGN KEY ([MedicalCenterGuid]) REFERENCES [dbo].[MedicalCenters] ([MedicalCenterGuid]);
...
ALTER TABLE [dbo].[Posts]
    ADD CONSTRAINT [FK_Post_Blog] FOREIGN KEY ([IdBlog]) REFERENCES [dbo].[Blogs] ([IdBlog]);
